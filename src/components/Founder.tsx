  ...
  return (
    <section className="grain relative bg-alabaster py-32 overflow-hidden">
      ...
      <div className="relative pl-6 pr-6 md:pl-[20vw] md:pr-12">
        ...
        <ScrollReveal delay={0.1} className="mt-12 w-full md:w-[45%]">
          <SmartImage folder="founder" alt="Neha Chhabria, founder of The Pluming Tales Company" className="aspect-[4/5] w-full" />
